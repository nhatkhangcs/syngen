...
```bash
git clone https://github.com/nhatkhangcs/syngen.git
cd syngen
make install_dev
```
...
- ✅ **Initial Release**: First stable release with core functionality
- ✅ **Updated Maintainer**: Now maintained by Vo Hoang Nhat Khang
